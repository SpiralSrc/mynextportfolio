...
export const YelpRecentLoginEmail = ({ userFirstName, loginDate, loginDevice, loginLocation, loginIp }: YelpRecentLoginEmailProps) => {
          ...
          <Section style={content}>
            ...
            <Row style={{ ...boxInfos, paddingBottom: "0" }}>
              <Column>
                ...
                <Text style={paragraph}>If this was you, there is nothing else you need to do.</Text>
                <Text style={{ ...paragraph, marginTop: -5 }}>
                  If this was not you or if you have additional questions, please see our support page.
                </Text>
              </Column>
            </Row>
