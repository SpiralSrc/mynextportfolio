...
const ProjectIntro = () => {
  ...
  return (
    <section id="projects" className="bg-primary/80 backdrop-blur-md py-10">
      <div className="max-w-7xl mx-auto px-3 xl:px-0 py-16 md:py-20 text-secondary">
        <h1 className="text-center text-5xl font-bold font-vibes mb-16 md:mb-24">Projects</h1>
